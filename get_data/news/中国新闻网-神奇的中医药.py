...
# 爬虫函数：抓取神奇的中医药频道的文章
def crawl_chinesemedicine():
    base_url = "https://channel.chinanews.com.cn/cns/cl/life-chinesemedicine.shtml"
    headers = {
    ...
    print(f"[总计] 成功抓取神奇的中医药文章 {len(articles)} 条")
    return articles
...
def job():
    ...
    articles = crawl_chinesemedicine()
    if articles:
        save_to_db(articles)
