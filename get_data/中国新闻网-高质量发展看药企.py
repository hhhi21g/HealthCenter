...
# 爬虫函数：抓取高质量发展看药企频道的文章
def crawl_pharmaceuticalcompanies():
    base_url = "https://channel.chinanews.com.cn/cns/cl/life-pharmaceuticalcompanies.shtml"
    headers = {
    ...
    print(f"[总计] 成功抓取高质量发展看药企文章 {len(articles)} 条")
    return articles
...
def job():
    ...
    articles = crawl_pharmaceuticalcompanies()
    if articles:
        save_to_db(articles)
...
print("高质量发展看药企频道定时抓取已启动，每小时运行一次.")
