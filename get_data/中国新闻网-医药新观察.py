...
# 爬虫函数：抓取医药新观察频道的文章
def crawl_observationsonmedicine():
    base_url = "https://channel.chinanews.com.cn/cns/cl/life-observationsonmedicine.shtml"
    headers = {
    ...
    print(f"[总计] 成功抓取医药新观察文章 {len(articles)} 条")
    return articles
...
def job():
    ...
    articles = crawl_observationsonmedicine()
    if articles:
        save_to_db(articles)
