...
# 爬虫函数：抓取大医生来了频道的文章
def crawl_doctoriscoming():
    base_url = "https://channel.chinanews.com.cn/cns/cl/life-doctoriscoming.shtml"
    headers = {
    ...
    print(f"[总计] 成功抓取大医生来了文章 {len(articles)} 条")
    return articles
